...
kotlin {
    ...
    val xcf = XCFramework("Gix")

    macosArm64 {
        binaries.framework { baseName = "Gix"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Gix"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Gix"
        flattenPackage = "io.github.kotlinmania.gix"
    }

    android {
        namespace = "io.github.kotlinmania.gix"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "gix-kotlin", version.toString())

    pom {
        name.set("gix-kotlin")
        description.set("Kotlin Multiplatform port of GitoxideLabs/gitoxide - Interact with git repositories just like git would")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/gix-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/gix-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/gix-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/gix-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.gix.codeql
