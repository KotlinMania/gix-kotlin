...
This file is the quick-reference operating contract for gix-kotlin. The longer
...
gix-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`gix`](https://crates.io/crates/gix). Upstream Rust is the behavioral oracle while the
