# gix-kotlin in Kotlin

[![GitHub link](https://img.shields.io/badge/GitHub-KotlinMania%2Fgix--kotlin-blue.svg)](https://github.com/KotlinMania/gix-kotlin)
[![Maven Central](https://img.shields.io/maven-central/v/io.github.kotlinmania/gix-kotlin)](https://central.sonatype.com/artifact/io.github.kotlinmania/gix-kotlin)
[![Build status](https://img.shields.io/github/actions/workflow/status/KotlinMania/gix-kotlin/ci.yml?branch=main)](https://github.com/KotlinMania/gix-kotlin/actions)

This is a Kotlin Multiplatform line-by-line transliteration port of [`GitoxideLabs/gitoxide`](https://github.com/GitoxideLabs/gitoxide).

**Original Project:** This port is based on [`GitoxideLabs/gitoxide`](https://github.com/GitoxideLabs/gitoxide). All design credit and project intent belong to the upstream authors; this repository is a faithful port to Kotlin Multiplatform with no behavioural changes intended.
...
## Upstream README — `GitoxideLabs/gitoxide`

> The text below is reproduced and lightly edited from [`https://github.com/GitoxideLabs/gitoxide`](https://github.com/GitoxideLabs/gitoxide). It is the upstream project's own description and remains under the upstream authors' authorship; links have been rewritten to absolute upstream URLs so they continue to resolve from this repository.
...
[![asciicast](https://github.com/GitoxideLabs/gitoxide/blob/HEAD/etc/gix-asciicast.svg)](https://asciinema.org/a/542159)
 ...
 * Apache License, Version 2.0, ([LICENSE-APACHE](https://github.com/GitoxideLabs/gitoxide/blob/HEAD/LICENSE-APACHE) or
   http://www.apache.org/licenses/LICENSE-2.0)
 * MIT license ([LICENSE-MIT](https://github.com/GitoxideLabs/gitoxide/blob/HEAD/LICENSE-MIT) or
...
This Kotlin port is distributed under the same MIT license as the upstream [`GitoxideLabs/gitoxide`](https://github.com/GitoxideLabs/gitoxide). See [LICENSE](LICENSE) (and any sibling `LICENSE-*` / `NOTICE` files mirrored from upstream) for the full text.

Original work copyrighted by the gitoxide authors.  
Kotlin port: Copyright (c) 2026 Sydney Renee and The Solace Project.

### Acknowledgments

Thanks to the [`GitoxideLabs/gitoxide`](https://github.com/GitoxideLabs/gitoxide) maintainers and contributors for the original Rust implementation. This port reproduces their work in Kotlin Multiplatform; bug reports about upstream design or behavior should go to the upstream repository.
