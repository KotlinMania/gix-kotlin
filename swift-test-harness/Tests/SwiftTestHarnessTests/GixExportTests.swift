...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Gix.swiftmodule/`
...
//      `import Gix` above would fail at compile time.
//
//   2. The static archive `libGix.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Gix" }` and
//      `flattenPackage = "io.github.kotlinmania.gix"` configuration in
...
final class GixExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "Gix swift module imported cleanly")
    }
}
